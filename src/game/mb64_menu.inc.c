...
struct mb64_info_entry mb64_v1_1_changelog[] = {
    ...
    {"     Sky, Cave, Spooky, Castle, Retro", 0},
    {"", 0},
    {"Conveyors", 1},
    {"", 0},
    ...
    {"- Koopa the Quick respawns after losing the race or falling", 0},
    {"    into the death plane", 0},
    ...
    {"- BTCM Powerups will be lost when taking damage", 0},
    ...
    {"- Incorrect coin star IDs in levels with 8 or more stars", 0},
    ...
    {"    Levels with names over 35 characters will not load", 0},
    ...
    {"- Created in future version message not cleared when", 0},
    {"    changing pages on level selection menu", 0},
...
void render_mb64_mm_menu(char * strlist[], char *title, u8 ct) {
    ...
    if ((mb64_mm_state == MM_MAIN) || (mb64_mm_state == MM_MAIN_LIMITED)) {
        print_maker_string_ascii(243, 188 + mb64_menu_title_vels[0], "v1.1 beta 4", MB64_TEXT_WHITE);
        print_maker_string_ascii_centered(160, 175 + mb64_menu_title_vels[0], "By: Rovertronic & Arthurtilly", MB64_TEXT_WHITE);
    }
