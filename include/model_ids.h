...
#define MODEL_BREAKABLE_BOX_SMALL         0x82        // breakable_box_no_shadow_geo
...
#define MODEL_MARIOS_METAL_CAP            0x86        // vanetalc_geo
#define MODEL_MARIOS_WING_CAP             0x87        // rocket_boot_geo
...
#define MODEL_TRAJECTORY_MARKER_BALL      0xE1        // bowling_ball_track_geo

enum MakerModelIDs {
    MODEL_NOTEBLOCK = 0xE2,
    MODEL_REX,
    MODEL_GREEN_COIN,
    MODEL_HAMMER_BRO,
    MODEL_HAMMER,
    MODEL_MONEYBAG,
    MODEL_SB,
    MODEL_MAKER_MAIN_MENU,
    MODEL_PODOBOO,
    MODEL_MAKER_TREE_1,
    MODEL_MAKER_TREE_2,
    MODEL_MAKER_TREE_3,
    MODEL_MAKER_TREE_4,
    MODEL_MAKER_BOUNDARY,
    MODEL_SPAWN,
    MODEL_MAKER_PIPE,
    MODEL_BADGE,
    MODEL_KINGBOMB_MAKER,
    MODEL_WHOMP_MAKER,
    MODEL_SPINY_BALL,
    MODEL_SPINY,
    MODEL_WIGGLER_HEAD,
    ...
    MODEL_KOOPA_FLAG,
    MODEL_VEXCLAMATION_BOX,
    MODEL_V_MARIOS_WING_CAP,
    MODEL_V_MARIOS_METAL_CAP,
    MODEL_THWOMP_MAKER,
    MODEL_BILL_MAKER,
    MODEL_BILL_MAKER_2,
    MODEL_LAKITU_MAKER,
    ...
    MODEL_MAKER_MRI_2,
    MODEL_MAKER_PLANT,
    MODEL_MAKER_SPINDRIFT,
    MODEL_MAKER_BLIZZARD,
    MODEL_MAKER_HEAVEHO,
    MODEL_MAKER_BOWSER_BOMB,
    MODEL_MAKER_BOWSER,
    MODEL_MAKER_SCUTTLEBUG,
    MODEL_MAKER_CRABLET,
    MODEL_MAKER_FIREBAR,
    MODEL_MAKER_GRINDEL,
    MODEL_LOOPINGP,
    MODEL_MAKER_BFLAMES,
    MODEL_MAKER_BSHOCKWAVE,
    MODEL_CULL_MARKER,
    MODEL_MAKER_MOTOS,
    MODEL_MAKER_SKEETER,
    MODEL_MAKER_CHICKEN,
    MODEL_MAKER_EGG,
    MODEL_MAKER_FLAMETHROWER,
    MODEL_MAKER_POKEY_BODY,
    MODEL_MAKER_POKEY_HEAD,
    MODEL_MAKER_TREE_5,
    MODEL_MAKER_TIMEDBOX,
    MODEL_MAKER_TREE_6,
    MODEL_MAKER_DIAMOND,
    MODEL_MAKER_BUTTON,
    MODEL_MAKER_BLOCK_OFF,
    MODEL_MAKER_BLOCK_ON,
    MODEL_MAKER_WOODPLAT,
    MODEL_MAKER_RFBOX,
    MODEL_MAKER_SHOWRUNNER,
    MODEL_MAKER_SHOWRUNNER_SPIKE,
    MODEL_MAKER_SHOWRUNNER_BALL,
    MODEL_MAKER_SHOWRUNNER_BALL_2,
    MODEL_MAKER_SHOWRUNNER_STAR,
    MODEL_MAKER_FATPLAT,
    MODEL_MAKER_CROWBAR,
    MODEL_MAKER_MASK,
    MODEL_MAKER_TOAD,
    ...
    MODEL_MAKER_MOLEMAN,
    MODEL_MAKER_COBIE,
    MODEL_MAKER_CONVEYOR,
    MODEL_MAKER_CONVEYOR_HALF,
    MODEL_MAKER_CONVEYOR_SLOPE,
    MODEL_MAKER_CONVEYOR_DSLOPE,
    MODEL_MAKER_IMBUE,
    MODEL_MAKER_IMBUE_STAR,
    MODEL_MAKER_IMBUE_COIN,
    MODEL_MAKER_IMBUE_BADGE,
    MODEL_MAKER_IMBUE_TRIGGER,
};
