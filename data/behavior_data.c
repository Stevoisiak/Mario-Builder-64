...
const BehaviorScript bhvHeaveHo[] = {
    ...
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 120, /*Gravity*/ -400, /*Bounciness*/ -50, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
...
const BehaviorScript bhvGhostHuntBoo[] = {
    ...
    SET_FLOAT(oGraphYOffset, 30),
    //CALL_NATIVE(bhv_init_room),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ 0, /*Bounciness*/ -50, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 0, /*Unused*/ 0, 0),
    CALL_NATIVE(bhv_boo_init),
    BEGIN_LOOP(),
...
const BehaviorScript bhvFlyGuy[] = {
    ...
    SET_HOME(),
    SET_FLOAT(oDrawingDistance, MB64_DRAWDIST_LOW),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 50, /*Gravity*/ 0, /*Bounciness*/ 0, /*Drag strength*/ 0, /*Friction*/ 1000, /*Buoyancy*/ 0, /*Unused*/ 0, 0),
    SET_INT(oInteractionSubtype, INT_SUBTYPE_TWIRL_BOUNCE),
    SET_FLOAT(oGraphYOffset, 30),
    SCALE(/*Unused*/ 0, /*Field*/ 150),
    BEGIN_LOOP(),
...
const BehaviorScript bhvEnemyLakitu[] = {
    ...
    SET_HOME(),
    SET_FLOAT(oDrawingDistance, MB64_DRAWDIST_LOW),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 40, /*Gravity*/ 0, /*Bounciness*/ -50, /*Drag strength*/ 0, /*Friction*/ 0, /*Buoyancy*/ 0, /*Unused*/ 0, 0),
    BEGIN_LOOP(),
...
const BehaviorScript bhvSkeeter[] = {
    ...
    SET_HOME(),
    SET_FLOAT(oDrawingDistance, MB64_DRAWDIST_LOW),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 125, /*Gravity*/ -400, /*Bounciness*/ -50, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 1200, /*Unused*/ 0, 0),
    BEGIN_LOOP(),
...
const BehaviorScript bhvShowrunner[] = {
    ...
    SET_FLOAT(oDrawingDistance, MB64_DRAWDIST_HIGH),
    ANIMATE(0),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 125, /*Gravity*/ -400, /*Bounciness*/ -50, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_HOME(),
    BEGIN_LOOP(),
